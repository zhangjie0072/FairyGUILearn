...
public class Lua_FairyGUI_ScrollPane : LuaObject {
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_scrollingPosX(IntPtr l) {
		try {
			FairyGUI.ScrollPane self=(FairyGUI.ScrollPane)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.scrollingPosX);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static public int get_scrollingPosY(IntPtr l) {
		try {
			FairyGUI.ScrollPane self=(FairyGUI.ScrollPane)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.scrollingPosY);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"scrollingPosX",get_scrollingPosX,null,true);
		addMember(l,"scrollingPosY",get_scrollingPosY,null,true);
