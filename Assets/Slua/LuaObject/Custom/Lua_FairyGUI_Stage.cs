...
public class Lua_FairyGUI_Stage : LuaObject {
	...
	static public int SetCustomInput(IntPtr l) {
		try {
			...
			if(matchType(l,argc,2,typeof(UnityEngine.RaycastHit),typeof(bool))){
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.RaycastHit),typeof(bool),typeof(bool))){
				FairyGUI.Stage self=(FairyGUI.Stage)checkSelf(l);
				UnityEngine.RaycastHit a1;
				checkValueType(l,2,out a1);
				System.Boolean a2;
				...
				self.SetCustomInput(ref a1,a2,a3);
				pushValue(l,true);
				pushValue(l,a1);
				return 2;
			}
			else if(matchType(l,argc,2,typeof(UnityEngine.Vector2),typeof(bool),typeof(bool))){
				FairyGUI.Stage self=(FairyGUI.Stage)checkSelf(l);
				UnityEngine.Vector2 a1;
				checkType(l,2,out a1);
				System.Boolean a2;
